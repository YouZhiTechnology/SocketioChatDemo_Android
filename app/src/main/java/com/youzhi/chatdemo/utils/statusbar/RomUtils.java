package com.youzhi.chatdemo.utils.statusbar;
...
public class RomUtils {
	...
	protected static boolean isFlymeV4OrAbove() {
	...
	protected static boolean isMIUIV6OrAbove() {
	...
	//MIUI V6对应的versionCode是4
	//MIUI V7对应的versionCode是5
	protected static boolean isMiUIV7OrAbove() {
		String miuiVersionCodeStr = getSystemProperty("ro.miui.ui.version.code");
		if (!TextUtils.isEmpty(miuiVersionCodeStr)) {
			try {
				int miuiVersionCode = Integer.parseInt(miuiVersionCodeStr);
	...
	//Android Api 23以上
	protected static boolean isAndroidMOrAbove() {
