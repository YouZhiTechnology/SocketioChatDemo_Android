...
public class ImagePreviewActivity extends AppCompatActivity implements Handler.Callback, View.OnClickListener {
    ...
    // 自定义保存按钮显示状态
    private boolean svaeButtonStatus = false;
    // 关闭按钮显示状态
    ...
    private View btn_show_save_pic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isShowSaveButton = ImagePreview.getInstance().isShowSaveButton();
        ...
        btn_show_save_pic = findViewById(R.id.btn_show_save_pic);
        ...
        // 下载图片按钮
        btn_show_save_pic.setOnClickListener(this);
        if (!isShowIndicator) {
        ...
        if (isShowSaveButton) {
            btn_show_save_pic.setVisibility(View.VISIBLE);
            svaeButtonStatus = true;
        } else {
            btn_show_save_pic.setVisibility(View.GONE);
            svaeButtonStatus = false;
        }
        // 更新进度指示器
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.img_download) {// 检查权限
            ...
            onBackPressed();
        } else if (i == R.id.btn_show_save_pic) {
            downLoadImage();
        }
    }
